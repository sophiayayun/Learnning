 ...
 */
public class ServerCompletionHandler implements CompletionHandler<AsynchronousSocketChannel, ServerOfAIO> {


    public void completed(AsynchronousSocketChannel channel, ServerOfAIO attachment) {
    ...
    public void failed(Throwable exc, ServerOfAIO attachment) {
        exc.printStackTrace();
    }
